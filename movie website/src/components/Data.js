        ...
        return (
            <div className="box-detail" style={back}>
                ...
                <div className="box-text">
                    <p>{this.state.imdbData.Country}</p>
                    <p>{this.state.imdbData.Runtime}</p>
                    <p>{this.state.imdbData.imdbVotes}</p>
                    <p>{this.state.imdbData.Rated}</p>
                    <p>{this.state.imdbData.Year}</p>
                    <p>{this.state.imdbData.totalSeasons}</p>
                    <p>{this.state.imdbData.Country}</p>
                    <p>{this.state.imdbData.Language}</p>
